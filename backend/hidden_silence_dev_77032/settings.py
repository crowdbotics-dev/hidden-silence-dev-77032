"""
Django settings for hidden_silence_dev_77032 project.
...
ROOT_URLCONF = 'hidden_silence_dev_77032.urls'
...
WSGI_APPLICATION = 'hidden_silence_dev_77032.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_silence_dev_77032 API",
    "DESCRIPTION": "API documentation for hidden_silence_dev_77032 App",
    "VERSION": "v1",
}
